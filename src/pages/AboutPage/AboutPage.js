...
export default function AboutPage() {
    ...
    const handleMouseEnterO = () => {
      setImageDescriptionO('別擔心！有了記憶術的幫忙，學習漢字變得有趣又好玩。');
  ...
  return (
    <Root>
      ...
      <Paragraph style={{ paddingLeft: '30px' }}>
        本網站目的在向大家推廣漢字詞學習相關研究和產品。包含「鍵接圖系列教材」和「實用中日同形詞攻略法」兩大部分的成果。「鍵接圖系列教材」採用獨創的「鍵接圖學習法」學習漢字詞，透過關「鍵」串「接」漢字形和意的「圖」像，以創意的日常圖像輔助學習者學習漢字，提升學習認字和寫字的效率。「實用中日同形詞攻略法」透過精緻化策略、分類等記憶術和比較中日漢字詞使用上的異同，為日籍華語學習者提供學習漢字詞的妙方。我們奠基於豐厚的學術成果和有力的實徵研究支持，已開發多款教研產品，期望能對學習者、教學者和家長帶來實質的幫助。
        </Paragraph>
      </Container>
     
      <Container>
        <Paragraph style={{ paddingRight: '30px' }}>
        本網站架構為：關於我們、學術成果、實務應用。透過「關於我們」，您可以了解網站目的，並取得學習資源和聯繫方式；透過「學術成果」，您可以看到團隊在漢字詞領域豐富的期刊論文；透過「實務應用」，您可以進一步認識漢字詞學習週邊產品，讓學習變得更有趣、有效、有意思。
        <br/><br/>
